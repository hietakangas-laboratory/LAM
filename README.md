...
'python LAM-master/setup.py install'. Windows-users may need to install Shapely>=1.7.0 from a pre-compiled wheel found
[here](https://www.lfd.uci.edu/~gohlke/pythonlibs/#shapely) in order to properly link GEOS and cython.
...
includes argument parsing for most important settings ('python src/run.py -h'). Refer to 'docs/UserManual' for
